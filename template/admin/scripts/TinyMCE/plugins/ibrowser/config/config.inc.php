<?php
	...
	//-------------------------------------------------------------------------
	$cfg['lang']   		= 'bg';														// default language; e.g. 'en'
...
/*		array (
	...
	$cfg['ilibs'] = array (																// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
		array (
			'value'   	=> '/arkaintour.com/uploads/',
			'text'    	=> 'Галерия',
		),
		array (
			'value'   	=> '/arkaintour.com/uploads/categories/',
			'text'    	=> 'Категории',
		)
	);
	//-------------------------------------------------------------------------
	...
	$cfg['ilibs_dir'] 	   = array('/uploads/');						   	// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
